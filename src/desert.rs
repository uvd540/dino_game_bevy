...
impl Plugin for DesertPlugin {
    fn build(&self, app: &mut App) {
        app
            .add_startup_system_to_stage(StartupStage::PreStartup, load_desert_assets)
...
fn load_desert_assets (
    ...
    let mut texture_atlas = TextureAtlas::new_empty(spritesheet_texture_handle, Vec2::new(1233., 68.));
    // Ground Sprite
